...
const BUNDLED_REGISTRY: FeatureRegistry = {
  ...
  features: [
    ...
    { id: "mood-board", label: "Mood Board", icon: "🎨", category: "Visual", webPath: "/projects/:id/mood-board", description: "Visual tone and style references", minTier: "amateur", hasNative: true },
    { id: "color-grading", label: "Color Grading", icon: "🌈", category: "Visual", webPath: "/projects/:projectId/color-grading", description: "AI-assisted color grade your footage", minTier: "independent", hasNative: true },
    ...
    { id: "sound-effects", label: "Sound Effects", icon: "🔊", category: "Post-Production", webPath: "/projects/:id/sound-effects", description: "AI sound design and effects", minTier: "independent", hasNative: true },
