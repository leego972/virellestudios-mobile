...
export const users = mysqlTable("users", {
  ...
  subscriptionTier: mysqlEnum("subscriptionTier", ["free","indie","amateur","independent","creator","studio","industry"]).default("free").notNull(),
  subscriptionStatus: mysqlEnum("subscriptionStatus", ["none","active","trialing","past_due","canceled","unpaid"]).default("none"),
